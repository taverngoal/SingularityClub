angular.module("SingularityClub1", [])
    .controller("impress", ["$scope", function ($scope) {
        ...
        $scope.langs_dic = {
            ...
            "javascript": {text: "Javascript", description: "一种直译式脚本语言，是一种动态类型、弱类型、基于原型的语言，内置支持类型，为浏览器的一部分，广泛用于客户端的脚本语言。"},
            "perl": {text: "Perl", description: "被称之为“一种拥有各种语言功能的梦幻脚本语言”、“Unix 中的王牌工具”。"},
            "vb": {text: "Visual Basic", description: "是一种由 Microsoft 公司开发的结构化的、模块化的、面向对象的、包含协助开发环境的事件驱动为机制的可视化程序设计语言。"},
            ...
            "swift": {text: "Swift", description: "苹果于2014年WWDC（苹果开发者大会）发布的新开发语言，可与Objective-C*共同运行于Mac OS和iOS平台，用于搭建基于苹果平台的应用程序。"},
            "dart": {text: "Dart", description: "是一种“结构化的Web编程”语言"},
            "as": {text: "ActionScript", description: "是一种完全的面向对象的编程语言，功能强大，类库丰富，语法类似JavaScript，多用于Flash互动性、娱乐性、实用性开发，网页制作和RIA（因特网应用程序）开发"},
            ...
            "scala": {text: "Scala", description: "可伸缩的语言[1] 是一种多范式的编程语言，一种类似java的编程[2] ，设计初衷是要集成面向对象编程和函数式编程的各种特性。Scala是在JVM上运行。"},
